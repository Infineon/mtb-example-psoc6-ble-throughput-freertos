...
/*******************************************************************************
* Function Name: void Cy_EINK_Start(int8_t temperature)
********************************************************************************
*
...
/*******************************************************************************
* Function Name: bool Cy_EINK_Power(bool powerCtrl)
********************************************************************************
*
...
bool Cy_EINK_Power(bool powerCtrl)
{
    ...
    uint8_t pwrStatus = CY_EINK_OPERATION_FAILURE;
    ...
    {
        pwrStatus = CY_EINK_OPERATION_SUCCESS;
    }
    /* If the operation was not successful, return "false" */
    else
    {
        pwrStatus = CY_EINK_OPERATION_FAILURE;
    }
...
*
* Parameters:
*  cy_eink_frame_t* prevFrame    : Pointer to the previous frame written on the display
*  cy_eink_frame_t* newFrame     : Pointer to the new frame that need to be written
...
*  cy_eink_frame_t* image         : Pointer to the image array (typically in flash)
*  uint8_t* imgCoordinates   : Pointer to a 4-byte array of image coordinates
*
* Return:
*  None
*
                                ...
                                uint8_t* imgCoordinates)
{
         ...
         pixelLineCounter++)
    {
       ...
       /* Find the length of the pixel line to be copied */
        lineLength = imgCoordinates[CY_EINK_IMG_X2] - imgCoordinates[CY_EINK_IMG_X1];
...
void Cy_EINK_TextToFrameBuffer(cy_eink_frame_t* frameBuffer, char* string, 
                            cy_eink_font_t* fontInfo, uint8_t* fontCor)
{ 
                     ...
                     verticalCounter++)
                {
                         ...
                         horizontalCounter++)
                    {
                        ...
                        frameByte = horizontalCounter + (printLocation +
                                    (PV_EINK_HORIZONTAL_SIZE * verticalCounter));
