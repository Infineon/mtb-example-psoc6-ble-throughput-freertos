...
#define EINK_CS         CYBSP_D10   /* SPI CS output pin */
#define EINK_RST        CYBSP_D2    /* Display reset output pin */
#define EINK_BUSY       CYBSP_D3    /* Display busy input pin */
#define EINK_DISCHARGE  CYBSP_D5    /* Display discharge output pin */
#define EINK_ENABLE     CYBSP_D4    /* Display enable output pin */
#define EINK_BORDER     CYBSP_D6    /* Display border output pin */
#define EINK_IOENABLE   CYBSP_D7    /* Display IO Enable output pin */
...
#define CY_EINK_CsHigh         cyhal_gpio_write(EINK_CS, CY_EINK_PIN_HIGH)

/* Pull the chip select pin to logic LOW */
#define CY_EINK_CsLow          cyhal_gpio_write(EINK_CS, CY_EINK_PIN_LOW)

/* Push the reset pin to logic HIGH */
#define CY_EINK_RstHigh        cyhal_gpio_write(EINK_RST, CY_EINK_PIN_HIGH)

/* Pull the reset pin to logic LOW */
#define CY_EINK_RstLow         cyhal_gpio_write(EINK_RST, CY_EINK_PIN_LOW)
...
#define CY_EINK_TurnOnVcc      cyhal_gpio_write(EINK_ENABLE, CY_EINK_PIN_HIGH)

/* Turn off the display by pulling the display enable pin to logic LOW */
#define CY_EINK_TurnOffVcc     cyhal_gpio_write(EINK_ENABLE, CY_EINK_PIN_LOW)
...
#define CY_EINK_EnableIO       cyhal_gpio_write(EINK_IOENABLE, CY_EINK_PIN_LOW)

/* Push the Enable I/O pin to logic HIGH */
#define CY_EINK_DisableIO      cyhal_gpio_write(EINK_IOENABLE, CY_EINK_PIN_HIGH)
